const fonts = [
    { id: 1, fontName: 'Roboto', fontFamily: "'Roboto','Helvetica','Arial',sans-serif" },
    { id: 2, fontName: '阿里妈妈方圆体', fontFamily: "'阿里妈妈方圆体 VF Regular', 'Roboto','Helvetica','Arial',sans-serif" },
];
...
const changeFont = (fontFamily: string) => {
    document.documentElement.style.setProperty('--full-use-user-font-family', fontFamily);
    localStorage.setItem('font', fontFamily);
};
export { fonts, fontTypographyList, changeFont };
