    ...
    return (
        <Box overflow="hidden">
            <Card sx={{ maxWidth: 345, m: 2 }}>
                ...
                />
                <CardMedia component="img" height="194" image="https://v5.mui.com/static/images/cards/paella.jpg" alt="Paella dish" />
                <CardContent>
                ...
                <Collapse in={expanded} timeout="auto" unmountOnExit>
                    <CardContent>
                        ...
                        <Typography paragraph>
                            ...
                            stirring occasionally until lightly browned, 6 to 8 minutes. Transfer shrimp to a large plate and set aside, leaving chicken and
                            chorizo in the pan. Add pimentón, bay leaves, garlic, tomatoes, onion, salt and pepper, and cook, stirring often until thickened and
                        ...
                        <Typography paragraph>
                            ...
                            absorbed, 15 to 18 minutes. Reduce heat to medium-low, add reserved shrimp and mussels, tucking them down into the rice, and cook
                            again without stirring, until mussels have opened and rice is just tender, 5 to 7 minutes more. (Discard any mussels that don&apos;t
                            open.)
                        </Typography>
