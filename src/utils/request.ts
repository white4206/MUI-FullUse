...
service.interceptors.response.use(
    res => {
        ...
        if (code === 401) {
            ...
            // TODO 消息提示 ElMessage({ message: msg, type: 'error' });
            return Promise.reject(new Error(msg));
        } else if (code === 601) {
            // TODO 消息提示 ElMessage({ message: msg, type: 'warning' });
            return Promise.reject(new Error(msg));
        } else if (code !== 200) {
            // TODO 消息通知 ElNotification.error({ title: msg });
    ...
    error => {
        ...
        // TODO 消息提示 ElMessage({ message: message, type: 'error', duration: 5 * 1000 });
